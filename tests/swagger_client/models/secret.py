...
class Secret(object):
    ...
    def __init__(self, code=None, secret=None):
        """
    ...
    def code(self):
        """
        Gets the code of this Secret.

        :return: The code of this Secret.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        """
        Sets the code of this Secret.

        :param code: The code of this Secret.
        :type: str
        """
