...
class MarketTest(ApiUser):
    def test_market(self):
        ...
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.5)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.5)
        self.request('new_market', DEV_3_INT, [2, 10, 10], sleep=0.3)
        self.request('trade', DEV_1_INT, [1000, 1, 1, 2, 20, [127,0,0,1], 3030], sleep=0.2)
        self.request('trade', DEV_1_INT, [3000, 1, 1, 2, 20, [127,0,0,1], 3030], sleep=0.2)
        self.request('trade', DEV_2_INT, [6000, 2, 2, 2, 20, [127,0,0,1], 3030], sleep=0.2)
        self.request('trade', DEV_2_INT, [8000, 2, 2, 2, 20, [127,0,0,1], 3030], sleep=0.2)
        self.request('market_match', DEV_3_INT, [2], sleep=0.3)
        self.request('pull_channel_state', DEV_2_INT, [[127,0,0,1], 3030], sleep=0.3)
